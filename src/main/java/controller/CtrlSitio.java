 ...
 * @author Waldir
 */
@WebServlet(name="CtrlSitio", urlPatterns={"/buzon","/error","/ayuda","/mensaje","/recuperacion", "/servicios", "/registro", "/login", "/contacto", "/nosotros", "/movil", "/web"})
public class CtrlSitio extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        switch(url){
            ...
            break;
            case "/servicios":
                recurso = "Servicios.html";
            break;     
            case "/nosotros":
                recurso = "Nosotros.html";
            break;    
            case "/movil":
                recurso = "movil.html";
            break;    
